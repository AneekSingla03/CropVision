...
/**
 * Signup Page Component (Evaluation 1 - Static Form Prototype)
 * 
 * Demonstrates:
 * - Professional registration layout
 * - Reusable form inputs and styling
 * - React Router Link navigation to /login
 */
function Signup() {
  return (
